...
# ============================================================
# CARREGAMENTO DOS DADOS A PARTIR DO JSON
# ============================================================
_DATA_FILE = os.path.join(os.path.dirname(__file__), "alunos_t3.json")
with open(_DATA_FILE, "r", encoding="utf-8") as _f:
    _data = json.load(_f)

ALUNOS_T3 = _data["alunos"]
CURSO_INFO = _data["curso_info"]
